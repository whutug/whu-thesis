...
\begin{function}{style/bib-style}
    ...
    \end{fdusyntax}
    设置参考文献样式。\opt{author-year} 和 \opt{numerical} 分别对应国家标准 GB/T 7714--2005 中的著者—出版年制和顺序编码制。\kvopt{type}{doctor} 或 \opt{doctor} 时默认为 \opt{author-year}，\kvopt{type}{bachelor} 或 \opt{opening} 时默认为 \opt{numerical}。
\end{function}

% \emph{武汉大学要求参考文献遵循 GB/T 7714--2005 规范，但目前 GB/T 7714 的最新版本是 GB/T 7714--2015，\pkg{gbt7714} 缺乏对 GB/T 7714--2005 的良好支持，因此最终效果可能无法完全满足格式规范的要求。}
