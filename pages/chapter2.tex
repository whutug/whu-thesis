...
\begin{figure}
  \centering
  \subcaptionbox{武汉大学校徽\label{fig:subfig-a}}
    {\includegraphics[width=0.2\linewidth]{whulogo.pdf}}
  \subcaptionbox{武汉大学\label{fig:subfig-b}}
    {\includegraphics[width=0.7\linewidth]{whu.pdf}}
  \caption{多个分图的示例}
