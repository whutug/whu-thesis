...
用户也可以直接使用 \hologo{XeLaTeX} 或 \hologo{LuaLaTeX} 配合 \hologo{BibTeX} 进行编译，编译链如下所示。
\begin{lstlisting}[language=bash]
$ xelatex main.tex  
$ bibtex main.aux
$ xelatex main.tex
